#!/bin/bash
# filepath: gearboxAssembly/scripts/rule_based_sun_gear_3.sh
...
CMD="python scripts/rule_based_agent.py --task=Template-Galaxea-Sun-Gear-3-v0 --enable_cameras"

# Define runtime for each iteration (seconds)
# Shorter runtime for testing
RUNTIME=120  
