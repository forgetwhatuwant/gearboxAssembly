...
def batch_convert_roco_to_lerobot():
    parser = argparse.ArgumentParser(description="BATCH Convert ROCO HDF5 dataset to LeRobot format.")
    ...
    parser.add_argument("--max_episodes", type=int, default=None, help="Max episodes to convert (Optional)")
