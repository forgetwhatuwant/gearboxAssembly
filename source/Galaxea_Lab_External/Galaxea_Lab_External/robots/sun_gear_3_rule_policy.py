...
class SunGear3RulePolicy:
    ...
    obj_dict: dict):
        ...
        # Mount the gear to the planetary_carrier (slower for precision)
        self.time_step_2 = torch.tensor([0.0, 1.0, 1.0, 0.5, 0.5], device=sim.device)  # Slower movement during mount
        ...
        # Mount the 2nd gear to the planetary_carrier (slower for precision)
        self.time_step_4 = torch.tensor([0.0, 1.0, 1.0, 0.5, 0.5], device=sim.device)  # Slower movement during mount
        ...
        # Mount the 3rd gear to the planetary_carrier (slower for precision)
        self.time_step_7 = torch.tensor([0.0, 1.0, 1.0, 0.5, 0.5], device=sim.device)  # Slower movement during mount
        ...
        # STOP HERE - Total time steps based on end of step 7
    ...
    def prepare_mounting_plan(self,
        ...
        Args:
            ...
            gear_names: List of gear names to plan for (e.g., ['sun_planetary_gear_1', 'sun_planetary_gear_2'])
                    If None, defaults to first 3 sun planetary gears
        ...
        # Default to first 3 gears if not specified for this specific policy
    ...
    def mount_gear_to_target(self,
        ...
        # Mount the gear on the planetary carrier
