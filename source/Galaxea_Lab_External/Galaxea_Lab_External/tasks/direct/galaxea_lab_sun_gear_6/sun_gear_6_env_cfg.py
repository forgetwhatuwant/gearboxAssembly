...
"""Configuration for Sun Gear 6 environment - Stage 2 curriculum (gears 4-6)."""
...
@configclass
class SunGear6EnvCfg(DirectRLEnvCfg):
    ...
    # Gears 1-3 will be pre-positioned on pins during reset
    ...
    # Gear 4, ring gear and reducer are on table (to be assembled in stage 2)
